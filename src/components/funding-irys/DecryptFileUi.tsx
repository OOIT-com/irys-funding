...
export function DecryptFileUi() {
  ...
  return (
    <Stack spacing={2}>
      ...
      <LDBox sx={{ fontSize: '1.6em', margin: '1em 0 0.4em 0' }}>Decryption and Download of Files</LDBox>

      <CollapsiblePanel
        key={'create-file-information'}
        title={'Upload encrypted Files with Meta Data'}
        collapsible={false}
        toolbar={[
          <Button
            key={'clear-button'}
      ...
      <CollapsiblePanel
        ...
        content={[
          ...
          <Button
            ...
            onClick={async () => {
              if (encryptedFile && metadata) {
                const res = await wrap('Decrypt and download original file...', () =>

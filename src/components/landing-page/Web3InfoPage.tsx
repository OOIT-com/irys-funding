                    ...
                    <TableContainer key="table" component={Paper}>
                        <Table sx={{minWidth: 800}}>
                            <TableBody>
                                ...
                                <TableRowInfo key={'name'} label={'Network Name'}
                                              value={loading || !web3 ? 'loading' : name}/>
                                <TableRowInfo key={'chain-id'} label={'Chain Id'}
                                              value={loading || !web3 ? 'loading' : '' + chainId}/>
                                <TableRowInfo
                                    key={'gas-price-wei'}
                                    label={'Gas Price Wei'}
                                    value={loading || !web3 ? 'loading' : gasPriceWei + ''}
                                />
                                <TableRowInfo key={'faucet-urls'} label={'Faucet Urls'} type={'link'}
                                              values={faucetUrls}/>
                                <TableRowInfo
